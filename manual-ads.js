...
function mk(slot){
 ...
 w.style.cssText="margin:20px auto;max-width:970px;min-width:300px;min-height:280px;text-align:center;background:#fafafa;border-radius:8px;display:flex;align-items:center;justify-content:center;";
