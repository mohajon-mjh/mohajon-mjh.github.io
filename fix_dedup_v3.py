print("🔧 Dedup v3: সঠিক insertion + verification")

with open("admin.html", "r", encoding="utf-8") as f:
    c = f.read()

if "mjh-dedup-float-v3" in c:
    print("⚠️  আগে থেকেই আছে"); raise SystemExit

script = '''
<script>/*mjh-dedup-float-v3*/
(function(){
...
with open("admin.html", "r", encoding="utf-8") as f:
    check = f.read()
print("✅ LOCAL PROOF:", "mjh-dedup-float-v3" in check)
